  ...
  'pt-BR': {
    translation: {
      ...
      library: {
        ...
        updatePatchDetails: 'Patch de {{size}} · {{savings}}% de economia',
      ...
      downloads: {
        ...
        verifying_update: 'Verificando atualização',
        full_fallback: 'Baixando pacote completo com segurança',
  ...
  'en-US': {
    translation: {
      ...
      library: {
        ...
        updatePatchDetails: '{{size}} patch · {{savings}}% savings',
